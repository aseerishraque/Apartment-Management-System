      ...
      <form onSubmit="return validateMe();" action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="form-group">
            ...
            <input type="text" name="txtBrName" value="<?php echo $branch_name ;?>" id="txtBrName" class="form-control" required />
          </div>
          <div class="form-group">
            <label for="txtBrEmail"><?php echo $_data['text_5'];?> :</label>
            <input type="text" name="txtBrEmail" value="<?php echo $b_email; ?>" id="txtBrEmail" class="form-control" required />
          </div>
          <div class="form-group">
            <label for="txtBrConNo"><?php echo $_data['text_6'];?> :</label>
            <input type="text" name="txtBrConNo" value="<?php echo $b_contact_no;  ?>" id="txtBrConNo" class="form-control" required />
          </div>
          <div class="form-group">
            <label for="txtareaAddress"><?php echo $_data['text_7'];?> :</label>
            <textarea rows="3" name="txtareaAddress" id="txtareaAddress" class="form-control" required><?php echo $b_address;?></textarea>
          </div>
		  <div class="form-group">
            <label for="radioStatus"><?php echo $_data['text_8'];?> :</label>&nbsp;&nbsp;
                    <input class="minimal" type="radio"  name="radioStatus" required id="radioStatus" <?php if($b_status == 'enable'){echo 'checked=checked';}?> value="enable" />&nbsp;&nbsp;<span><?php echo $_data['text_9'];?></span>&nbsp;&nbsp;
                    <input class="minimal" type="radio"  name="radioStatus" required id="radioStatus" <?php if($b_status == 'disable'){echo 'checked=checked';}?>  value="disable" />&nbsp;&nbsp;<span><?php echo $_data['text_10'];?></span>
          </div>
